...
def get_simple_composition(steps=1000, components=5):
    ...
    for _ in range(components):
        ...
        x += get_sine_wave(frequency=frequency, amplitude=amplitude, shift_x=shift_x, shift_y=shift_y)
    return x
...
if __name__ == "__main__":
    ...
    for i in range(N):
        ...
        shift_x = (np.random.random() - 0.5) * 2
        shift_y = (np.random.random() - 0.5) * 2
        sine_wave = get_sine_wave(frequency=frequency, amplitude=amplitude, shift_x=shift_x, shift_y=shift_y)
